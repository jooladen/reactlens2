...
def log(message):
    ...
    with open(os.path.join(PROJECT_ROOT, LOG_FILE), "a", encoding="utf-8") as f:
        f.write(line + "\n")
...
def run_chunk(chunk):
    ...
    if process.returncode != 0:
        log(f"ERROR: Chunk {chunk['number']} 실패 (종료코드: {process.returncode})")
...
def main():
    ...
    print("\n================================")
    print("  Code Skeleton Viewer 자동 실행")
    print("================================\n", flush=True)
